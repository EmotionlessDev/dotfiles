...
-- Bind :Format to <leader>gf for the current buffer
vim.keymap.set('n', '<leader>gf', ':Format<CR>',
  { buffer = bufnr, noremap = true, silent = true, desc = 'Format with LSP' })
...
local servers = { 'rust_analyzer', 'pyright', 'gopls', 'clangd', 'psalm', 'phpactor', 'volar', 'html', 'cssls', 'cmake',
  'omnisharp', 'lua_ls', 'vimls' }
